...
public class RendererTest {
    ...
    private static ArrayList<Mesh> create_mesh_list_for_test() {
        ...
        meshes.add(new Mesh(new Vertex(0, 0, 0), Color.RED) {
            ...
            void setTrianglesList() {
                this.trianglesList = new ArrayList<>(List.of(new Triangle(new Vertex(0, 0, 0, 0, 0), new Vertex(15, 15, 0), new Vertex(15, 0, 0))
                        , new Triangle(new Vertex(100, 100, 100, 1, 0), new Vertex(15, 15, 0), new Vertex(200, 0, 0))));
    ...
    @Test
    void renderer_rotation_shapes_test() {
        ...
        Assertions.assertEquals(firstTriangle.getVertex1(), new Vertex(0, 0, 0, 0, 0));
        Assertions.assertEquals(firstTriangle.getVertex2(), new Vertex(15 * cos(0.05), 15, 15 * -sin(0.05), 0, 0));
        Assertions.assertEquals(firstTriangle.getVertex3(), new Vertex(15 * cos(0.05), 0, 15 * -sin(0.05), 0, 0));

        Assertions.assertEquals(secondTriangle.getVertex1(), new Vertex(100 * cos(0.05) + 100 * sin(0.05), 100, 100 * -sin(0.05) + 100 * cos(0.05), 1, 0));
        Assertions.assertEquals(secondTriangle.getVertex2(), new Vertex(15 * cos(0.05), 15, 15 * -sin(0.05), 0, 0));
        Assertions.assertEquals(secondTriangle.getVertex3(), new Vertex(200 * cos(0.05), 0, 200 * -sin(0.05), 0, 0));
    }
    ...
    void renderer_rotation_mesh_test() {
        ...
        Assertions.assertEquals(firstTriangle.getVertex2(), new Vertex(0, 0.9987502603949663 * 50 + 0.04997916927067833 * 50 + 50, -0.04997916927067833 * 50 + 0.9987502603949663 * 50 + 50, 0, 0));
